...
class WebApiSQLMapper:
    ...
    def __setSQL(self):
        ...
        """
        getParameterPropertySQL="""
        select wpp.*,wp.Required from webapi_parameter wp left join webapi_parameter_property wpp on wp.Id = wpp.WebApiParameterId
        where wp.Id=%(webapiParameterId)s
        """
        ...
        self.data.setdefault("getParameterProperty", getParameterPropertySQL)